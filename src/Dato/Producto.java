...
public class Producto {
   private int id;
    ...
    public Producto(int id, String nombre, int cantidad, int codigo,int almacen_id, int categoria_id,int actividad_id){
        this.id=id;
        this.nombre=nombre;
    ...
    public void setActividad(int actividad_id ) {
        this.actividad_id = actividad_id;
    } 
}
