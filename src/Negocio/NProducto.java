...
public class NProducto {
  private DProducto dproducto;
        ...
        if (esNumero(id)) {
            ...
            if (!lista.isEmpty()) {
                String res = "<h2> Lista de Producto </h2>\n"
                        ...
                        + "<td align=\"center\"valign=\"top\"  bgcolor=\"#7FFFD4\" style=\"font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px;\">Nombre</td>"
                        + "<td align=\"center\"valign=\"top\"  bgcolor=\"#7FFFD4\" style=\"font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px;\">Cantidad</td>"
                        ...
                        + "<td align=\"center\"valign=\"top\"  bgcolor=\"#7FFFD4\" style=\"font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px;\">Almacen_id</td>"
                        + "<td align=\"center\"valign=\"top\"  bgcolor=\"#7FFFD4\" style=\"font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px;\">Categoria_id</td>"
                        + "<td align=\"center\"valign=\"top\"  bgcolor=\"#7FFFD4\" style=\"font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px;\">Actividad_id</td>"
                        + "</tr>\n";
    ...
    public String crear(String[] parametros) {
        ...
        if (parametros.length == 6 && esNumero(parametros[4])&& esNumero(parametros[3])) {
            if (dproducto.crear(parametros[0], Integer.valueOf(parametros[1]),Integer.valueOf(parametros[2]),Integer.valueOf(parametros[3]),Integer.valueOf(parametros[4]),Integer.valueOf(parametros[5]))) {
    ...
    public String editar(String[] parametros) {
        ...
        if (parametros.length == 7 && esNumero(parametros[0]) && esNumero(parametros[5])&& esNumero(parametros[4])) {
            if (dproducto.editar(Integer.valueOf(parametros[0]),parametros[1], Integer.valueOf(parametros[2]),Integer.valueOf(parametros[3]),Integer.valueOf(parametros[4]),Integer.valueOf(parametros[5]),Integer.valueOf(parametros[6]))) {
