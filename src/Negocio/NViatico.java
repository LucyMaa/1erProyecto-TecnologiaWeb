...
public class NViatico {
        ...
        if (esNumero(id)) {
            ...
            if (!lista.isEmpty()) {
                String res = "<h2> Lista de Viatico </h2>\n"
                        ...
                        + "<td align=\"center\"valign=\"top\"  bgcolor=\"#7FFFD4\" style=\"font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px;\">Monto</td>"
                        + "<td align=\"center\"valign=\"top\"  bgcolor=\"#7FFFD4\" style=\"font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px;\">Fecha</td>"
                        + "<td align=\"center\"valign=\"top\"  bgcolor=\"#7FFFD4\" style=\"font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px;\">Razon</td>"
                        + "<td align=\"center\"valign=\"top\"  bgcolor=\"#7FFFD4\" style=\"font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px;\">Usser_id</td>"
    ...
    public String crear(String[] parametros) {
        ...
        if (parametros.length == 4 && esNumero(parametros[3])) {
            if (dviatico.crear(Integer.valueOf(parametros[0]), Date.valueOf(parametros[1]),parametros[2],Integer.valueOf(parametros[3]))) {
    ...
    public String editar(String[] parametros) {
        ...
        if (parametros.length == 5 && esNumero(parametros[0]) && esNumero(parametros[4])) {
            ...
            mensaje = "Error al editar el Viatico";
        }
        return errorMessage(mensaje);
    }
    ...
    public String eliminar(String id) {
        ...
        if (esNumero(id)) {
            if (dviatico.eliminar(Integer.valueOf(id))) {
                return successMessage("Viatico eliminado exitosamente!!");
            }
            mensaje = "Error al eliminar el Viatico";
        }
        return errorMessage(mensaje);
    }
