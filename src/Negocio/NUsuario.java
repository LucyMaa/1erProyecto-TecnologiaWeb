...
public class NUsuario {
        ...
        if (esNumero(id)) {
            ...
            if (!lista.isEmpty()) {
                String res = "<h2> Lista de Usuario </h2>\n"
                        ...
                        + "<td align=\"center\"valign=\"top\"  bgcolor=\"#7FFFD4\" style=\"font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px;\">Apellido</td>"
                        + "<td align=\"center\"valign=\"top\"  bgcolor=\"#7FFFD4\" style=\"font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px;\">CI</td>"
                        + "<td align=\"center\"valign=\"top\"  bgcolor=\"#7FFFD4\" style=\"font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px;\">Correo</td>"
                        + "<td align=\"center\"valign=\"top\"  bgcolor=\"#7FFFD4\" style=\"font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px;\">Nombre_rol</td>"
                        + "</tr>\n";
    ...
    public String crear(String[] parametros) {
        ...
        if (parametros.length == 6) {
            if (dusuario.crear(parametros[0], parametros[1],Integer.valueOf(parametros[2]),parametros[3],parametros[4],parametros[5])) {
    ...
    public String editar(String[] parametros) {
        ...
        if (parametros.length == 7) {
            if (dusuario.editar(Integer.valueOf(parametros[0]),parametros[1], parametros[2],Integer.valueOf(parametros[3]),parametros[4],parametros[5],parametros[6])) {
