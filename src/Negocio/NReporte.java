...
public class NReporte {
    ...
    public String reporteServicioPlan(){
        ...
        if(reporte.size()>0){
            String s_res = "<h2>Reporte de plan con sus servicios</h2>";
            s_res = s_res + "<table border=1>"
                        ...
                        + "<th align=\"center\"valign=\"top\"  bgcolor=\"#7FFFD4\" style=\"font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px;\">Tipo</th>"
            ...
            for (Reporte reporte1 : reporte) {
                ...
                s_res = s_res + "<td>" + reporte1.getEstado()+ "</td>";
                s_res = s_res + "</tr>";
            }
            s_res = s_res + "</table>";
            return s_res;
    ...
    public String resporteSignacionTecnico(){
        ...
        if(reporte.size()>0){
            String s_res = "<h2>Reporte tecnicos con sus servicios asignados</h2>";
            s_res = s_res + "<table border=1>"
                    + "<tr>"
                    + "<th align=\"center\"valign=\"top\"  bgcolor=\"#7FFFD4\" style=\"font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px;\">Direccion</th>"
