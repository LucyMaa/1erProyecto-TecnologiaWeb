...
public class NActividad {
        ...
        if(esNumero(id)){
            ...
            if(!lista.isEmpty()){
                String res = "<h2> Lista de Actividades </h2>\n"
                        ...
                        + "<td align=\"center\"valign=\"top\"  bgcolor=\"#7FFFD4\" style=\"font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px;\">Inicio</td>"
                        + "<td align=\"center\"valign=\"top\"  bgcolor=\"#7FFFD4\" style=\"font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px;\">Fin</td>"
                        + "<td align=\"center\"valign=\"top\"  bgcolor=\"#7FFFD4\" style=\"font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px;\">Foto</td>"
    ...
    public String editar(String[] parametros){
        String mensaje = "Error en los parametros tiene: "+parametros.length+" deberia ser solo 6 parametros";
        if(parametros.length == 6 && esNumero(parametros[0])){
            if(dactividad.editar(Integer.valueOf(parametros[0]), Date.valueOf(parametros[1]), Date.valueOf(parametros[2]), parametros[3], parametros[4], Integer.valueOf(parametros[5]))){
